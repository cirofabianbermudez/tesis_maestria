 ...
 * Description: Sproot chaotic map simulation using fixed point and mod 256 output in binary in windows
 * Compile: gcc -o A7_chaotic_mod_bin_wind.exe A7_chaotic_map_mod_bin_wind.c
 * Run: ./A7_chaotic_mod_bin_wind.exe
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
