\chapter{Random Number Generators (RNGs)}
    ...
    \section{Fuentes de aleatoriedad en los dispositivos lógicos}
        ...
        \subsection{Modelos estocásticos y pruebas específicas}
            ...
            El modelo sólo es práctico cuando las probabilidades que define se basan en algunos parámetros medibles. Examinaremos más de cerca los modelos estocásticos a través de un ejemplo de un TRNG elemental basado en osciladores de funcionamiento libre [14]. Los autores de [14] proponen un modelo basado en la fase de la señal de reloj generada por un oscilador de funcionamiento libre y definen la probabilidad de que un bit de salida sea uno mediante la ecuación (\ref{})

            El uso de modelos estocásticos resulta práctico únicamente cuando las probabilidades que definen se basan en parámetros medibles. Para ilustrar esto, examinaremos más de cerca los modelos estocásticos mediante un ejemplo de un TRNG elemental basado en osciladores de funcionamiento libre, tal y como se describe en \ref{Baudet2010}. Los autores de este trabajo proponen un modelo basado en la fase de la señal de reloj generada por un oscilador de funcionamiento libre y definen la probabilidad de que un bit de salida sea uno mediante la ecuación (\ref{eq:probabilidad}).
