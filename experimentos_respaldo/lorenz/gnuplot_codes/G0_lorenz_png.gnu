...
# Date: 16/06/2022
# Desing name: G0_lorenz_png.gnu
# Description: Plot from data file to png
# Run: gnuplot G0_lorenz_png.gnu
...
set output "lorenz_oscillator_xz.png"
plot filename using 1:3 with lines linestyle 1

set output "lorenz_oscillator_yz.png"
plot filename using 2:3 with lines linestyle 1

set output "lorenz_oscillator_3d.png"
set view 76, 220
