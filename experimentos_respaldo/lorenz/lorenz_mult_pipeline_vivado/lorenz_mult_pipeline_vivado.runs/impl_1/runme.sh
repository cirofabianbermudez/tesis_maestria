...
HD_PWD='C:/Users/Ciro/Desktop/lorenz/lorenz_mult_pipeline_vivado/lorenz_mult_pipeline_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lorenz.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lorenz.tcl -notrace
