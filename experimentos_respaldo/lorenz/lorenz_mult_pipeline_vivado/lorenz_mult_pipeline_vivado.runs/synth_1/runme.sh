...
HD_PWD='C:/Users/Ciro/Desktop/lorenz/lorenz_mult_pipeline_vivado/lorenz_mult_pipeline_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lorenz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lorenz.tcl
