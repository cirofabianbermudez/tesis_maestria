...
\newpage
\lstinputlisting[style = C, caption =  Simulación de mapa caótico en punto flotante., label = cod:A2]{codigos/c_codes/A2_chaotic_map.c}

\newpage
\lstinputlisting[style = C, caption =  Simulación de mapa caótico en punto fijo., label = cod:A3]{codigos/c_codes/A3_chaotic_map_fp.c}
...
\newpage
\lstinputlisting[style = C, caption = Generador de memoria ROM., label = cod:A4]{codigos/c_codes/A4_rom_gen_chaotic_map.c}
...
% \lstinputlisting[style = VHDL, caption = Testbench de mapa caótico., label = cod:tb_cm]{codigos/vhdl_codes/chaotic_map/tb_cm.vhd}
